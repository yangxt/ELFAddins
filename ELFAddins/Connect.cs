namespace ELFAddins
{
	...
	// you will need to re-register the Add-in by building the ELFAddinsSetup project, 
	...
	[GuidAttribute("F65A908A-3CD5-4C30-84AB-2BF8E23D01AB"), ProgId("ELFAddins.Connect")]
	public class Connect : Object, Extensibility.IDTExtensibility2
	{
        ...
        {
            if (Macro.instance.isStarted)
            {
                //return;
            }
            Macro.instance.isStarted = true;
            proxy.initService();
            proxy.startService();
        }
        ...
        {
            proxy.stopService();
            Macro.instance.isStarted = false;
        }
